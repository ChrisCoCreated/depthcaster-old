...
export function CastComposer({ parentHash, onSuccess }: CastComposerProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className={`${parentHash ? '' : 'border-b border-gray-200 dark:border-gray-800'} p-4`}>
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <button
              ...
              className="px-6 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-full font-medium hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
