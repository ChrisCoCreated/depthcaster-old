...
- **Conversation over broadcasting**: Threaded discussions and meaningful replies are central to the experience
- **Curation over chaos**: Hybrid filtering combines algorithmic signals with manual curation
...
- **For You**: Personalized recommendations based on your interests and interactions
- **Following**: A clean view of casts from users you follow
- **My 37**: A personal feed featuring up to 37 carefully selected users you choose, perfect for creating your own intimate social circle

### Advanced Content Filtering

The platform uses a sophisticated hybrid filtering system that combines:

- **Algorithmic Intelligence**: User quality scores, cast length analysis, and engagement depth metrics
- **Manual Curation**: Curated lists of high-quality users and specialized channels
- **Community Signals**: Reply depth, engagement quality, and conversation threading
- **Customizable Filters**: Hide short casts, trading-related content, dollar casts, and more
...
Create and share custom collections of users called "Curator Packs." These packs allow you to:

- Build your own curated lists of interesting users
- Share packs publicly or keep them private
- Discover packs created by others
- Filter feeds by specific packs to focus on particular communities or topics

### Real-Time Notifications

Stay connected with a comprehensive notification system that tracks:

- Replies to your casts
- Quotes of your content
- Mentions and interactions
- Follows, likes, and recasts
...
- Enjoy a seamless, app-like experience across all devices
...
- **Cast Linking**: Feedback entries can optionally link to specific casts for context
- **User Attribution**: All entries show who created them, with profile links and avatars
- **Unified Management**: Both build ideas and feedback are managed together in a single interface, distinguished by type badges

The system operates independently from cast tagging, providing a dedicated space for project planning and user input.

### User Customization

The platform offers extensive customization options:

- **Feed Settings**: Control what content appears in your feeds with granular filters
- **Notification Preferences**: Choose which types of notifications you want to receive
- **Curator Selection**: Pick which curators influence your curated feed
- **Sort Options**: Control how content is ordered in different feeds
- **Dark Mode**: Full dark mode support for comfortable viewing in any lighting
...
- **Image Support**: Rich media support for sharing art, photos, and visual content
- **Link Previews**: Automatic link unfurling for better context and discovery

## Technical Excellence

Built with modern web technologies:

- **Next.js 16**: Latest React framework for optimal performance
- **TypeScript**: Type-safe development for reliability
- **Neynar SDK**: Robust Farcaster protocol integration
- **PostgreSQL**: Reliable data storage for user preferences and state
